...
// Para este ejemplo, configuramos un vendedor estático
$id_vendedor = 1; // Cambia esto al ID del vendedor que desees mostrar

// Obtener el nombre del vendedor
$query_vendedor = "SELECT nombre FROM vendedor WHERE id_vendedor = $id_vendedor";
